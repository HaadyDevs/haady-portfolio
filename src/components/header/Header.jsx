...
import './header.css';
import CV from '../../assets/AbdulHaadyCV.pdf'
        ...
        <header className="header">
            <nav className="nav">
                <a href="index.html" className="nav__logo">
                    <img className="logo-img" src={require('../../assets/logolight1.png')} alt="Logo" />
                </a>
                <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
                    <ul className="nav__list grid">
                        ...
                        <li className="nav__item">
                            <a href={CV} className="button nav-button button--flex" download={"AbdulHaadyCV"}>Resume</a>
                        </li>
